...
public class ControleurJeu {
	...
	public void finDePartie(String message){
		...
		json.accumulate("chat","Partie terminé !!" + message);
	...
	public void setEtat(EtatJeu etat){
		this.etat = etat;
		this.Joueur1.changeEtat(etat);
		this.Joueur2.changeEtat(etat);
	}
	...
	public void setJoueur2(I_ControleurJoueur joueur2) {
		...
		this.setEtat( EtatJeu.PREPARATION);
	...
	public synchronized void finDeTour(I_ControleurJoueur joueur) {
		if(etat == EtatJeu.PREPARATION){
