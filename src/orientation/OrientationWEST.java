...
public class OrientationWEST implements I_Orientation {

	private static OrientationWEST instance;
	
	protected OrientationWEST(){
		
	}
	
	public static OrientationWEST getInstance(){
		if(instance == null){
			instance = new OrientationWEST();
		}
		return instance;
	}
