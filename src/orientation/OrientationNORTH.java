...
public class OrientationNORTH implements I_Orientation {
	
	private static OrientationNORTH instance;
	
	protected OrientationNORTH(){
		
	}
	
	public static OrientationNORTH getInstance(){
		if(instance == null){
			instance = new OrientationNORTH();
		}
		return instance;
	}
